...
namespace Infra.Tests.RabbitMQ.Consumers
{
    public class PedidoPreparandoSubscriberTests
    {
        ...
        public void AoExecuteAsync_SeNaoConseguirDesSerializarDto_DeveLancarExcessao()
        {
            ...
            var serverFake = new PedidoPreparandoSubscriberFake(mockScopeFactory.Object, _mockOptions.Object, mockModel.Object);
        ...
        {
            public PedidoPreparandoSubscriberFake(IServiceScopeFactory scopeFactory, IOptions<Secrets> options, IModel model) : base(scopeFactory, options, model)
            {
            }
