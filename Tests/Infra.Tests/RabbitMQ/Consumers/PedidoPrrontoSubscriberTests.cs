...
namespace Infra.Tests.RabbitMQ.Consumers
{
    public class PedidoProntoSubscriberTests
    {
        ...
        public void AoExecuteAsync_SeNaoConseguirDesSerializarDto_DeveLancarExcessao()
        {
            ...
            var serverFake = new PedidoProntoSubscriberFake(mockScopeFactory.Object, options, mockModel.Object);
        ...
        public void Dispose_ShouldCloseChannel()
        {
            ...
            var subscriber = new PedidoProntoSubscriber(mockScopeFactory.Object, options, mockModel.Object);
        ...
        {
            public PedidoProntoSubscriberFake(IServiceScopeFactory scopeFactory, RabbitMQOptions options, IModel model) : base(scopeFactory, options, model)
            {
            }
