...
namespace Infra.Tests.RabbitMQ.Consumers
{
    public class PedidoFinalizadoSubscriberTests
    {
        ...
        public void AoExecuteAsync_SeNaoConseguirDesSerializarDto_DeveLancarExcessao()
        {
            ...
            var serverFake = new PedidoFinalizadoSubscriberFake(mockScopeFactory.Object, _mockOptions.Object, mockModel.Object);
            ...
            Assert.Equal("Erro deserializar carrinhoDto", capturedException?.Message);
        }
        ...
        public void Dispose_ShouldCloseChannel()
        {
            ...
            var subscriber = new PedidoFinalizadoSubscriber(mockScopeFactory.Object, _mockOptions.Object, mockModel.Object);
        ...
        private class PedidoFinalizadoSubscriberFake : PedidoFinalizadoSubscriber
        {
            public PedidoFinalizadoSubscriberFake(IServiceScopeFactory scopeFactory, IOptions<Secrets> options, IModel model) : base(scopeFactory, options, model)
            {
            }
