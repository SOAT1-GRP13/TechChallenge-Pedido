...
namespace Infra.Tests.RabbitMQ.Consumers
{
    public class PedidoFinalizadoSubscriberTests
    {
        ...
        public void AoExecuteAsync_SeNaoConseguirDesSerializarDto_DeveLancarExcessao()
        {
            ...
            var options = new RabbitMQOptions { QueuePedidoFinalizado = "testQueue" };
            var serverFake = new PedidoFinalizadoSubscriberFake(mockScopeFactory.Object, options, mockModel.Object);
        ...
        public void Dispose_ShouldCloseChannel()
        {
            ...
            var subscriber = new PedidoFinalizadoSubscriber(mockScopeFactory.Object, options, mockModel.Object);
        ...
        {
            public PedidoFinalizadoSubscriberFake(IServiceScopeFactory scopeFactory, RabbitMQOptions options, IModel model) : base(scopeFactory, options, model)
            {
            }
